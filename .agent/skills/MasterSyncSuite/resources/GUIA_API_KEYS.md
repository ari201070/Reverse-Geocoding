...
- Debe estar habilitada la **"Geocoding API"** y la **"Places API" (New)** en la consola de desarrollo de Google (o utilizar los fallbacks locales como OpenCage configurados en el entorno).
...
- **Project ID:** `gen-lang-client-0238248708`
...
3. Verificar permisos de acceso a los modelos en Google AI Studio para la clave específica.