/**
 * Copia final de Chipre - Fase 1: Archivos pequeños (<10MB)
 */
...
console.log('═══════════════════════════════════════════════════════════════');
console.log('  FASE 5.1: COPIA CHIPRE - ARCHIVOS PEQUEÑOS (<10MB)');
console.log('═══════════════════════════════════════════════════════════════');
console.log('');
...
console.log(`   ⏭️  Saltados (>10MB): ${skippedLarge}`);
...
console.log('');
console.log('✅ Completado. Archivos grandes pendientes para fase 2.');
