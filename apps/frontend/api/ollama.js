...
export default async function handler(req, res) {
  ...
  if (DISABLE_OLLAMA) {
    console.log('[api/ollama] Request received but Ollama is disabled to save computer memory.');
    return res.status(200).json({ error: 'Ollama is disabled on this server.', models: [], msg: 'Ollama is disabled to save computer memory.' });
  }
