...
export class SharedContextManager {
   ...
   */
  async getOrCreateContext(overrideHeadless?: boolean, browserOptions?: BrowserOptions): Promise<BrowserContext> {
    ...
    if (await this.needsRecreation()) {
      ...
      await this.recreateContext(overrideHeadless, browserOptions);
    } else {
   ...
   * @param overrideHeadless Optional override for headless mode (true = show browser)
   */
  private async recreateContext(overrideHeadless?: boolean, browserOptions?: BrowserOptions): Promise<void> {
    ...
    const launchOptions = {
      ...
      timeout: browserOptions?.timeout_ms, // ✅ Use custom timeout
      locale: "en-US",
