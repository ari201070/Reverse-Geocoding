# DIRECTIVAS MAESTRAS DE ARQUITECTURA Y REGLAS PARA LA IA

Este documento reúne las directivas fundamentales para cualquier agente de IA o desarrollador que opere sobre el repositorio **Reverse-Geocoding**.

---

## 🏛️ 1. Las 4 Reglas de Oro Permanentes
...
## 🧭 2. Jerarquía de Inteligencia y Descubrimiento Espacial (.skills/)
...
## 🚀 3. Estrategia de Tokens y Eficiencia de Agente

* **Early Stop:** Si una solución es funcional, detén el agente y solicita validación.
* **Transparencia en Consola:** Muestra siempre recuentos claros, progreso y rutas reales durante las ejecuciones.
